...
public class Bishop extends Pieza{
    ...
    public Bishop(Tablero board, int row, int col, boolean iswhite){
        super(board, row, col, iswhite);
        try {
            if(iswhite) img = ImageIO.read(getClass().getResource("/images/aBlanco.png"));
            else img = ImageIO.read(getClass().getResource("/images/aNegro.png"));
