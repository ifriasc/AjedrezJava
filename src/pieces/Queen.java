...
public class Queen extends Pieza{
    ...
    public Queen(Tablero board, int row, int col, boolean iswhite){
        super(board, row, col, iswhite);
        try {
            if(iswhite) img = ImageIO.read(getClass().getResource("/images/qBlanco.png"));
            else img = ImageIO.read(getClass().getResource("/images/qNegro.png"));
